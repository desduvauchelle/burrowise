const en = {
	...
	// Hero
	'hero.title': 'Capture your thinking. Keep it yours.',
	'hero.subtitle': 'A private, local-first place to record ideas, search your knowledge, and think deeper with AI. Your files stay readable; encrypted sync is always optional.',
	'hero.cta.blog': 'Read the thinking',
	'hero.cta.vault': 'Open encrypted vault',
	'hero.cta.contact': 'Get in Touch',

	// Features
	'features.heading': 'Built around ownership, not lock-in',
	'features.ai.title': 'Speak before you organize',
	'features.ai.description': 'Capture natural voice turns first. Original audio and wording remain the source of truth.',
	'features.social.title': 'Markdown you can leave with',
	'features.social.description': 'Your brain is an ordinary folder. Open it in Obsidian, an editor, or any tool you choose.',
	'features.analytics.title': 'Zero-knowledge backup',
	'features.analytics.description': 'Optional sync encrypts filenames and contents in your client before the service receives them.',

	// CTA
	'cta.heading': 'Your second brain should belong to you.',
	'cta.subtitle': 'Use the desktop app entirely offline, or opt into an encrypted backup that the service cannot read.',
	'cta.button': 'Open the encrypted vault',
	...
	'footer.copyright': '\u00A9 {year} Burrowise. All rights reserved.',
